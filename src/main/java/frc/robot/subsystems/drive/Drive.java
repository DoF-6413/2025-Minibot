...
public class Drive extends SubsystemBase {
  private static final CANBus kCANBus = new CANBus(Constants.kCANBusName, "./logs/example.hoot");
  static final double ODOMETRY_FREQUENCY = kCANBus.isNetworkFD() ? 250.0 : 100.0;
  ...
  private static final RobotConfig PP_CONFIG =
      new RobotConfig(
          ...
          new ModuleConfig(
              ...
              WHEEL_COF,
              DCMotor.getKrakenX60Foc(1).withReduction(Constants.FrontLeft.driveMotorGearRatio()),
  ...
  public Drive(
    ...
    modules[2] = new Module(brModuleIO, 2, Constants.BackRight);
    modules[3] = new Module(blModuleIO, 3, Constants.BackLeft);
